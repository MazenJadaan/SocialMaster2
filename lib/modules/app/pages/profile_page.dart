        ...
        for (int i = 0; i < userData.allPosts!.length; i++) {
          for (int j = 0; j < userData.allPosts![i].post!.length; j++) {
            ...
            myPostData.add(MyPostModel(
              ...
              userImage:
                  '${AppSetting.baseUrl}${userData.profileInformation!.userProfile!.profilePhoto}',
              ...
              isLiked:
                  userData.allPosts![i].post![j].reaction == 0 ? false : true,
              isSaved: userData.allPosts![i].post![j].saved == 0 ? false : true,
                                      ...
                                      Column(
                                        children: [
                                          GestureDetector(
                                            ...
                                            child: Hero(
                                              tag: '${AppSetting.baseUrl}${user.coverPhoto!}',
                                              child: Container(
                                                width: double.infinity,
                                                height: 220,
                                                child: Image(
                                          ...
                                          children: [
                                            CircleAvatar(
                                              ...
                                              backgroundColor:
                                                  AppTheme.colors.purple,
                                              child: Hero(
                                                tag: '${AppSetting.baseUrl}${user.profilePhoto!}',
                                                child: CircleAvatar(
                                                  backgroundColor:
                                                      Colors.transparent,
                                                  radius: 56,
