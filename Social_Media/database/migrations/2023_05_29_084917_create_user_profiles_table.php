...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_profiles', function (Blueprint $table) {
            ...
            $table->string('cover_photo')->default('storage/public/images/cover_picture/default_cover_photo.png');
            $table->string('profile_photo')->default('storage/images/profile_picture/default_photo.png');
